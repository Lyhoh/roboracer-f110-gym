"""
Usage example:
  ros2 run <your_pkg> tf_bridge_map_odom \
    --odom-topic /ego_racecar/odom \
    --map-frame map --odom-frame odom --base-link-frame ego_racecar/base_link \
    --static-x 0.0 --static-y 0.0 --static-z 0.0 --static-yaw 0.0
"""
